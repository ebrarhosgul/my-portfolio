...
const PROJECTS_DATA = [
  ...
  },
  {
    ...
    source: '/projects/resume-analyzer.mp4',
    hasVideo: true,
    color: '#ea580c',
    stack: [
  ...
  },
  {
    ...
    source: '/projects/macbook-landing.mp4',
    hasVideo: true,
    color: '#06b6d4',
    stack: [
      { icon: SiReact, name: 'React' },
    ...
    const ctx = gsap.context(() => {
      ScrollTrigger.matchMedia({
        ...
        '(max-width: 1023px)': function () {
          const mobileCards = gsap.utils.toArray('.mobile-project-card');
