    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 w-full max-w-5xl h-auto md:h-[650px] relative z-10">
        ...
        <Card className="hidden md:flex md:col-span-1 md:row-span-1 flex-col items-center justify-center relative bg-neutral-900">
          <div
            className="absolute inset-0 opacity-40 bg-[url('/images/world-map.png')] bg-cover bg-center filter invert-[0.1]"
            aria-hidden="true"
          ></div>
          <div
        ...
        >
          <div
            className="absolute inset-0 bg-[url('/images/photo.jpeg')] bg-cover bg-center opacity-50 group-hover:opacity-100 transition-all duration-700 filter grayscale group-hover:grayscale-0 scale-110 group-hover:scale-100"
